          ...
          <div>
            ...
            <div className="flex space-x-4">
              {idFooter.social.map((item) => {
                ...
                if (!item.href) return null; // Skip if href is undefined or null
        ...
        <div className="border-t border-border pt-8 pb-16 sm:pb-0">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-primary/70 mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} {idFooter.companyName}.{" "}
              {idFooter.menu[4]?.label}
            </p>
