...
import { TfooterTarget } from "@repo/middleware/type";
            ...
            <div className="mt-6">
              ...
              <form action={formAction} className="flex gap-2">
                ...
                <Button type="submit" size="sm" disabled={pending}>
                  {pending
                    ? idFooter.footer.menu[4]?.description
                    : idFooter.footer.menu[4]?.icon}
                </Button>
              </form>
              {state?.message && (
        ...
        <div className="border-t border-border pt-8 pb-16 sm:pb-0">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-primary/70 mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} {idFooter.footer.companyName}.{" "}
              {idFooter.footer.menu[5]?.label}
            </p>
