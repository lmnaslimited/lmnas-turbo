...
export default function FreeOptIn(){
    ...
    const LCurrentLocale = (LLocale && LLocale in Li18n) ? LLocale : 'en';
    // Fallback to English if the requested locale doesn't exist
    const LdContent = Li18n[LCurrentLocale] || Li18n.en;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 lg:items-center">
          ...
          <div className="space-y-7">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-3 pt-2">
              {LdContent.signals.map((iSignal) => (
                <div key={iSignal} className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <div className="p-8">
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right leading-none">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">{LdContent.perMonth}</p>
                  </div>
                </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    {LdContent.capabilityList.map(({ label, available }) => (
                        <div
                        key={label}
