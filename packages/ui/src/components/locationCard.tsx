...
import { TlocationCard, Titems, Tbutton } from "@repo/middleware"
                                ...
                                (() => {
                                    ...
                                    return (
                                        <div className="flex items-start gap-4 p-6 bg-accent border border-accent backdrop-blur-sm">
                                            <div className="mt-1 flex-shrink-0">{renderIcon(lAddress.icon)}</div>
                        ...
                        >
                            {iLocation.navigation.href && (
                                ...
                                >
                                    ...
                                    {renderIcon(iLocation.navigation.icon)}
                                </Link>
                            )}
                        </div>
                    </div>
