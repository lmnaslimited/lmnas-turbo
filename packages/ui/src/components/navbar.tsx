...
import { BrainCog, Briefcase, PieChartIcon as ChartPie, Compass, DollarSign, EllipsisVertical, Factory, Globe, MoreHorizontal, Store, Truck, Users } from "lucide-react"
      ...
      >
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          <div className="flex items-center gap-6">
            {/* Logo and Brand */}
            <Link href={idNavbar.logo.href} className="flex items-center gap-2">
              <div className="w-10 h-10 bg-dark rounded-md flex items-center justify-center text-primary-foreground">
                <SVGComponent />
              </div>
              <span className="text-lg font-bold tracking-tight ">{idNavbar.logo.label}</span>
            </Link>
