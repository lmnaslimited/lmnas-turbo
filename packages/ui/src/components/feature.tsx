...
import { TfeatureProps, Titems, Tbutton } from "@repo/middleware/type";
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {idFeature.layout === "centered" ? (
        <div className="lg:text-center">
          <h2 className="text-base text-primary/70 font-semibold tracking-wide uppercase">
            {idFeature.heading?.badge}
          </h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        {idFeature.iShowButton && idFeature.buttonPosition !== "header" && (
          <div
            className={fnButtonContainer({
              position: idFeature.buttonPosition,
            })}
          >
            {idFeature.buttons?.[0]?.href && (
              <Link href={idFeature.buttons[0].href}>
...
const FAQItem = (idItems: Titems): ReactElement => {
  ...
  const IconComponent =
    idItems.icon &&
    (LucideIcons[
      idItems.icon as keyof typeof LucideIcons
  ...
  return (
    <div className="relative flex gap-4 items-start">
      ...
      <div className={IconComponent ? "ml-2" : ""}>
        <div className="text-lg leading-6 font-medium text-primary">
          {idItems.label}
        </div>
