...
const LaChartData = [
  {
    Question: "I have the skills, but where do I start?",
    value: 40,
    fill: "var(--chart-5)",
  },
  {
    Question: `Can I switch fields and be valued?`,
    value: 25,
    fill: "var(--chart-4)",
  },
  {
    Question: "How do I restart my career?",
    value: 15,
    fill: "var(--chart-3)",
  },
  {
    Question: "Where's my next big opportunity?",
    value: 20,
    fill: "var(--chart-2)",
  },
];
  ...
  return (
    <Card className="flex flex-col bg-accent shadow-none border-none">
      <CardContent className="flex-1 pb-0">
        <ChartContainer
          config={LdChartConfig}
          className="mx-auto aspect-square max-h-[250px]"
        >
          <PieChart>
            <ChartTooltip
              content={
                <ChartTooltipContent labelKey="Question" indicator="line" />
              }
            />
            <Pie
              data={LaChartData}
